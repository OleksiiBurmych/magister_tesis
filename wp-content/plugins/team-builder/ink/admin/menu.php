...
class wpsm_team_b {
    ...
    border: 1px solid #efda4a;
		   ...
		   <h1>Follow Us On</h1>
		   <a href="https://www.youtube.com/c/wpshopmart" target="_blank"><img style="width:200px;height:auto" src="<?php echo esc_url(wpshopmart_team_b_directory_url.'assets/images/youtube.png'); ?>" /></a>
		   <h3><?php esc_html_e('To Grab Free Web design Course & WordPress Help/Tips',wpshopmart_team_b_text_domain); ?></h3>
			
			<a href="https://www.youtube.com/c/wpshopmart?sub_confirmation=1" target="_blank" class="button button-primary button-hero "><?php esc_html_e('Subscribe Us Now',wpshopmart_team_b_text_domain); ?></a>
			<?php
	}
