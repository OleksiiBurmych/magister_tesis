...
class Admin {
	...
	/**
	 * Page ID with post type.
	 *
	 * @param string $current_screen The page ID.
	 * @return void
	 */
	...
	public function sptp_quicktag_text() {
		if ( wp_script_is( 'quicktags' ) ) {
			...
			<script>
			function team_list() {
			var data = <?php echo wp_json_encode( $team ); ?>;
			var s = $('<select />');
	...
	/**
	 * Tinymce button function
	 *
	 * @param array $plugin_array tinymce button.
	 * @return array
	 */
	public function sptp_team_tinymce_button( $plugin_array ) {
		$plugin_array['sptp_tinymce_button'] = SPT_PLUGIN_ROOT . 'src/Admin/js/tinymce.js';
		return $plugin_array;
	}
